...
import no.glv.paco.android.BaseTabActivity;
import no.glv.paco.android.DatePickerDialogHelper;
...
import no.glv.paco.intrfc.TaskController;
...
public class TaskViewActivity extends BaseTabActivity implements TaskController {
    ...
    public static class TaskInfoFragment extends BaseSwipeFragment implements OnDateSetListener,
            Task.OnAssignmentChangeListener {
        ...
        public void onDateSet( DatePicker view, int year, int monthOfYear, int dayOfMonth ) {
            ...
            getEditText( R.id.ET_task_date ).setText( BaseActivity.GetDateAsString( task.getDate() ) );
            task.notifyChange( Task.OnAssignmentChangeListener.DATE_CHANGE );
        }
    ...
    static class StudentListAdapter extends BaseExpandableListAdapter implements
            Task.OnAssignmentChangeListener, OnDateSetListener {
        ...
        public View getChildView( int groupPosition, int childPosition, boolean isLastChild, View convertView,
            ...
            imgSave.setOnClickListener( new View.OnClickListener() {
                ...
                public void onClick( View v ) {
                    ...
                    task.notifyChange( Task.OnAssignmentChangeListener.STD_UPDATE );
                    DataHandler.GetInstance().commitStudentsTasks( task );
        ...
        public void onDateSet( DatePicker view, int year, int monthOfYear, int dayOfMonth ) {
            ...
            mTask.notifyChange( Task.OnAssignmentChangeListener.DATE_CHANGE );
        }
