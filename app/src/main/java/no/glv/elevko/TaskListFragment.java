...
import no.glv.elevko.app.DataHandler.OnDataChangeListener;
...
public class TaskListFragment extends InstalledDataFragment<Integer>
        implements OnDataChangeListener, OnAssignmentChangeListener {
    ...
    public void onAssignmentChange( Task task, int mode ) {
        switch ( mode ) {
            case OnAssignmentChangeListener.STD_HANDIN:
